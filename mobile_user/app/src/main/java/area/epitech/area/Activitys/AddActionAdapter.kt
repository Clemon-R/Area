...
class AddActionAdapter(val models: List<ActionViewModel>, val context: Context, val frag: AddFragment) : SpinnerAdapter {

    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        frag.actionChanged(models[position])
    ...
    override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val model: ActionViewModel = models[position]
